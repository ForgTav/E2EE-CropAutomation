...
# BEFORE running the Computer
Before launching, you need to check if the robot is turned on. If it is off, turn it on and enter the command start.
...
# autoStat
The program **autoStat** will automatically stat-up your target crop until the Gr + Ga - Re is at least 52 for ALL crops on the working farm. Any crops with stats higher than these will be interpreted as weeds and removed.
